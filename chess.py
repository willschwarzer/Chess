...
def main(args):
    if args.player1 == "human":
        ...
        agent1 = mcts.MCTS(1, args.mcts_depth[0], args.mcts_rollouts[0],\
    ...
    if args.player2 == "human":
        ...
        agent2 = mcts.MCTS(-1, args.mcts_depth[1], args.mcts_rollouts[1],\
    ...
    for i in range(args.num_games):
        ...
        if args.alternate_sides:
            ...
            agent1 = agent2
            agent2 = temp
    if type(agent1) == mcts.MCTS:
        agent1.store_root()
    if type(agent2) == mcts.MCTS:
        agent2.store_root()
