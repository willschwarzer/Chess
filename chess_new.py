...
def hasFriend(side, row, col, board):
...
def hasEnemy(side, row, col, board):
...
def hasEnemyExceptKing(side, row, col, board):
...
def isThreatened(side, row, col, board):
...
class King(Piece):
    ...
    def makeMove(board, oldPosition, newPosition, isAI = False):
    ...
    def promote(board, piece, side, isAI):
